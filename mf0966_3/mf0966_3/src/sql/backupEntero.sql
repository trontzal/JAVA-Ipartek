CREATE DATABASE  IF NOT EXISTS `mf0966_3` /*!40100 DEFAULT CHARACTER SET utf8mb3 COLLATE utf8_bin */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `mf0966_3`;
...
CREATE TABLE `alumno` (
  ...
  `nombre` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8_bin NOT NULL,
  `apellidos` varchar(250) CHARACTER SET utf8mb3 COLLATE utf8_bin NOT NULL,
  `fNacimiento` date DEFAULT NULL,
  `direccion` varchar(250) CHARACTER SET utf8mb3 COLLATE utf8_bin DEFAULT NULL,
  `poblacion` varchar(150) CHARACTER SET utf8mb3 COLLATE utf8_bin DEFAULT NULL,
  `codigopostal` int(5) unsigned zerofill DEFAULT NULL,
  `telefono` int NOT NULL,
  `email` varchar(150) CHARACTER SET utf8mb3 COLLATE utf8_bin NOT NULL,
  `dni` varchar(9) CHARACTER SET utf8mb3 COLLATE utf8_bin NOT NULL,
...
CREATE TABLE `cliente` (
  ...
  `nombre` text CHARACTER SET utf8mb3 COLLATE utf8_bin NOT NULL,
  `email` varchar(150) CHARACTER SET utf8mb3 COLLATE utf8_bin NOT NULL,
  `telefono` int NOT NULL,
  `direccion` varchar(250) CHARACTER SET utf8mb3 COLLATE utf8_bin DEFAULT NULL,
  `poblacion` varchar(150) CHARACTER SET utf8mb3 COLLATE utf8_bin DEFAULT NULL,
  `codigopostal` int(5) unsigned zerofill DEFAULT NULL,
  `identificador` varchar(15) CHARACTER SET utf8mb3 COLLATE utf8_bin NOT NULL,
...
CREATE TABLE `curso` (
  ...
  `identificador` varchar(12) CHARACTER SET utf8mb3 COLLATE utf8_bin NOT NULL,
  `fInicio` date DEFAULT NULL,
  `fFin` date DEFAULT NULL,
  `nHoras` int NOT NULL,
  `temario` text CHARACTER SET utf8mb3 COLLATE utf8_bin,
  `activo` tinyint DEFAULT '1',
...
CREATE TABLE `puntuacion` (
  ...
  PRIMARY KEY (`codigo`),
  KEY `fk_puntuacion_alumno1_idx` (`alumno_codigo`),
  KEY `fk_puntuacion_curso1_idx` (`curso_codigo`),
  CONSTRAINT `fk_puntuacion_alumno1` FOREIGN KEY (`alumno_codigo`) REFERENCES `alumno` (`codigo`),
  CONSTRAINT `fk_puntuacion_curso1` FOREIGN KEY (`curso_codigo`) REFERENCES `curso` (`codigo`)
...
INSERT INTO `puntuacion` VALUES (4,5,1,1,'Texto editado'),(6,5,4,1,NULL),(7,4,2,2,NULL),(11,8,1,1,'Buen curso');
...
-- Dump completed on 2024-02-29 12:38:43
